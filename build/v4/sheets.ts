...
/**
 * Google Sheets API Client for Deno
 * =================================
 * 
...
export class Sheets {
  ...
  constructor(client?: CredentialsClient, baseUrl: string = "https://sheets.googleapis.com/") {
    this.#client = client;
   ...
   */
  async spreadsheetsBatchUpdate(spreadsheetId: string, req: BatchUpdateSpreadsheetRequest): Promise<BatchUpdateSpreadsheetResponse> {
   ...
   *
   */
  async spreadsheetsCreate(req: Spreadsheet): Promise<Spreadsheet> {
   ...
   */
  async spreadsheetsDeveloperMetadataGet(metadataId: number, spreadsheetId: string): Promise<DeveloperMetadata> {
    const url = new URL(`${this.#baseUrl}v4/spreadsheets/${ spreadsheetId }/developerMetadata/${ metadataId }`);
    const data = await request(url.href, {
      client: this.#client,
      method: "GET",
    });
    return data as DeveloperMetadata;
  }
   ...
   * @param spreadsheetId The ID of the spreadsheet to retrieve metadata from.
   */
  async spreadsheetsDeveloperMetadataSearch(spreadsheetId: string, req: SearchDeveloperMetadataRequest): Promise<SearchDeveloperMetadataResponse> {
    ...
    return data as SearchDeveloperMetadataResponse;
  }
   ...
   */
  async spreadsheetsGet(spreadsheetId: string, opts: SpreadsheetsGetOptions = {}): Promise<Spreadsheet> {
   ...
   * @param spreadsheetId The spreadsheet to request.
   */
  async spreadsheetsGetByDataFilter(spreadsheetId: string, req: GetSpreadsheetByDataFilterRequest): Promise<Spreadsheet> {
   ...
   */
  async spreadsheetsSheetsCopyTo(sheetId: number, spreadsheetId: string, req: CopySheetToAnotherSpreadsheetRequest): Promise<SheetProperties> {
    ...
    return data as SheetProperties;
  }
   ...
   */
  async spreadsheetsValuesAppend(range: string, spreadsheetId: string, req: ValueRange, opts: SpreadsheetsValuesAppendOptions = {}): Promise<AppendValuesResponse> {
    ...
    return data as AppendValuesResponse;
  }
   ...
   * -- all other properties of the cell (such as formatting and data
   * validation) are kept.
   *
   * @param spreadsheetId The ID of the spreadsheet to update.
   */
  async spreadsheetsValuesBatchClear(spreadsheetId: string, req: BatchClearValuesRequest): Promise<BatchClearValuesResponse> {
    ...
    return data as BatchClearValuesResponse;
  }
   ...
   * @param spreadsheetId The ID of the spreadsheet to update.
   */
  async spreadsheetsValuesBatchClearByDataFilter(spreadsheetId: string, req: BatchClearValuesByDataFilterRequest): Promise<BatchClearValuesByDataFilterResponse> {
    ...
    return data as BatchClearValuesByDataFilterResponse;
  }
   ...
   */
  async spreadsheetsValuesBatchGet(spreadsheetId: string, opts: SpreadsheetsValuesBatchGetOptions = {}): Promise<BatchGetValuesResponse> {
   ...
   * @param spreadsheetId The ID of the spreadsheet to retrieve data from.
   */
  async spreadsheetsValuesBatchGetByDataFilter(spreadsheetId: string, req: BatchGetValuesByDataFilterRequest): Promise<BatchGetValuesByDataFilterResponse> {
    ...
    return data as BatchGetValuesByDataFilterResponse;
  }
   ...
   * @param spreadsheetId The ID of the spreadsheet to update.
   */
  async spreadsheetsValuesBatchUpdate(spreadsheetId: string, req: BatchUpdateValuesRequest): Promise<BatchUpdateValuesResponse> {
    ...
    return data as BatchUpdateValuesResponse;
  }
   ...
   * @param spreadsheetId The ID of the spreadsheet to update.
   */
  async spreadsheetsValuesBatchUpdateByDataFilter(spreadsheetId: string, req: BatchUpdateValuesByDataFilterRequest): Promise<BatchUpdateValuesByDataFilterResponse> {
    ...
    return data as BatchUpdateValuesByDataFilterResponse;
  }
   ...
   * @param spreadsheetId The ID of the spreadsheet to update.
   */
  async spreadsheetsValuesClear(range: string, spreadsheetId: string, req: ClearValuesRequest): Promise<ClearValuesResponse> {
    ...
    return data as ClearValuesResponse;
  }
   ...
   * @param spreadsheetId The ID of the spreadsheet to retrieve data from.
   */
  async spreadsheetsValuesGet(range: string, spreadsheetId: string, opts: SpreadsheetsValuesGetOptions = {}): Promise<ValueRange> {
   ...
   * @param spreadsheetId The ID of the spreadsheet to update.
   */
  async spreadsheetsValuesUpdate(range: string, spreadsheetId: string, req: ValueRange, opts: SpreadsheetsValuesUpdateOptions = {}): Promise<UpdateValuesResponse> {
    const url = new URL(`${this.#baseUrl}v4/spreadsheets/${ spreadsheetId }/values/${ range }`);
    if (opts.includeValuesInResponse !== undefined) {
      url.searchParams.append("includeValuesInResponse", String(opts.includeValuesInResponse));
    }
    ...
    return data as UpdateValuesResponse;
  }
}
...
function serializeAddDataSourceResponse(data: any): AddDataSourceResponse {
  return {
    ...data,
    dataExecutionStatus: data["dataExecutionStatus"] !== undefined ? serializeDataExecutionStatus(data["dataExecutionStatus"]) : undefined,
  };
}

function deserializeAddDataSourceResponse(data: any): AddDataSourceResponse {
  return {
    ...data,
 ...
 * incremented and this new group G' has the depth of that group. For example, a
 * group [C:D, depth 1] + [B:E] results in groups [B:E, depth 1] and [C:D, depth
 * 2]. If the requested range is a subset of the range of an existing group G,
 ...
 * and [C:D, depth 2]. If the requested range starts before and ends within, or
 * starts within and ends after, the range of an existing group G, then the
 * range of the existing group G becomes the union of the ranges, and the new
 * group G' has depth one greater than the depth of G and range as the
 * intersection of the ranges. For example, a group [B:D, depth 1] + [C:E]
...
function serializeAppendCellsRequest(data: any): AppendCellsRequest {
  return {
    ...data,
...
function deserializeAppendCellsRequest(data: any): AppendCellsRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
 ...
 * takes priority over column_properties. For example, the first row color takes
 * priority over the first column color, but the first column color takes
 ...
 * over time, multiple series may exist, one for the "Open Price", "High Price",
...
function serializeBatchUpdateSpreadsheetRequest(data: any): BatchUpdateSpreadsheetRequest {
  return {
    ...data,
...
function deserializeBatchUpdateSpreadsheetRequest(data: any): BatchUpdateSpreadsheetRequest {
  return {
    ...data,
...
function serializeBatchUpdateSpreadsheetResponse(data: any): BatchUpdateSpreadsheetResponse {
  return {
    ...data,
    replies: data["replies"] !== undefined ? data["replies"].map((item: any) => (serializeResponse(item))) : undefined,
  };
}

function deserializeBatchUpdateSpreadsheetResponse(data: any): BatchUpdateSpreadsheetResponse {
  return {
    ...data,
    replies: data["replies"] !== undefined ? data["replies"].map((item: any) => (deserializeResponse(item))) : undefined,
  };
}
 ...
 * at background, you can check its state to tell if an execution completes
 ...
 * data execution to sync the data from the data source to the sheet. * Updating
 * a data source creates a data execution to refresh the associated data source
...
function serializeDataExecutionStatus(data: any): DataExecutionStatus {
  return {
    ...data,
...
function deserializeDataExecutionStatus(data: any): DataExecutionStatus {
  return {
    ...data,
...
function serializeDataSourceSheetProperties(data: any): DataSourceSheetProperties {
  return {
    ...data,
    dataExecutionStatus: data["dataExecutionStatus"] !== undefined ? serializeDataExecutionStatus(data["dataExecutionStatus"]) : undefined,
  };
...
function deserializeDataSourceSheetProperties(data: any): DataSourceSheetProperties {
  return {
    ...data,
    dataExecutionStatus: data["dataExecutionStatus"] !== undefined ? deserializeDataExecutionStatus(data["dataExecutionStatus"]) : undefined,
  };
...
export interface FilterCriteria {
   ...
   * are shown. Mutually exclusive with visible_foreground_color. Deprecated:
   * Use visible_background_color_style.
   */
 ...
 * end_column_index: 2` `Sheet1 == sheet_id: 123456` The start index must always
 * be less than or equal to the end index. If the start index equals the end
 * index, then the range is empty. Empty ranges are typically not meaningful and
 * are usually rendered in the UI as `#REF!`.
 */
 ...
 * by age that has 50+ rows: +-----+-------------------+ | Age | AVERAGE of
 * Amount | +-----+-------------------+ | 16 | $27.13 | | 17 | $5.24 | | 18 |
 * $20.15 | ... +-----+-------------------+ could be turned into a pivot table
...
export interface HistogramSeries {
   ...
   * field is optional. Deprecated: Use bar_color_style.
   */
  barColor?: Color;
  /**
   * The color of the column representing this series in each bucket. This
 ...
 * node, an optional tooltip. For example, to describe an OrgChart with Alice as
 * the CEO, Bob as the President (reporting to Alice) and Cathy as VP of Sales
...
function serializeRefreshDataSourceObjectExecutionStatus(data: any): RefreshDataSourceObjectExecutionStatus {
  return {
    ...data,
    dataExecutionStatus: data["dataExecutionStatus"] !== undefined ? serializeDataExecutionStatus(data["dataExecutionStatus"]) : undefined,
  };
...
function deserializeRefreshDataSourceObjectExecutionStatus(data: any): RefreshDataSourceObjectExecutionStatus {
  return {
    ...data,
    dataExecutionStatus: data["dataExecutionStatus"] !== undefined ? deserializeDataExecutionStatus(data["dataExecutionStatus"]) : undefined,
  };
...
function serializeRefreshDataSourceResponse(data: any): RefreshDataSourceResponse {
  return {
    ...data,
    statuses: data["statuses"] !== undefined ? data["statuses"].map((item: any) => (serializeRefreshDataSourceObjectExecutionStatus(item))) : undefined,
  };
}

function deserializeRefreshDataSourceResponse(data: any): RefreshDataSourceResponse {
  return {
    ...data,
    statuses: data["statuses"] !== undefined ? data["statuses"].map((item: any) => (deserializeRefreshDataSourceObjectExecutionStatus(item))) : undefined,
  };
}
 ...
 * keep the formula's ranges static, use the `$` indicator. For example, use the
 * formula `=$A$1` to prevent both the row and the column from incrementing.
 */
...
function serializeRepeatCellRequest(data: any): RepeatCellRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeRepeatCellRequest(data: any): RepeatCellRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeRequest(data: any): Request {
  return {
    ...data,
    appendCells: data["appendCells"] !== undefined ? deserializeAppendCellsRequest(data["appendCells"]) : undefined,
    repeatCell: data["repeatCell"] !== undefined ? deserializeRepeatCellRequest(data["repeatCell"]) : undefined,
    updateBanding: data["updateBanding"] !== undefined ? deserializeUpdateBandingRequest(data["updateBanding"]) : undefined,
    updateCells: data["updateCells"] !== undefined ? deserializeUpdateCellsRequest(data["updateCells"]) : undefined,
    updateDataSource: data["updateDataSource"] !== undefined ? deserializeUpdateDataSourceRequest(data["updateDataSource"]) : undefined,
    updateDeveloperMetadata: data["updateDeveloperMetadata"] !== undefined ? deserializeUpdateDeveloperMetadataRequest(data["updateDeveloperMetadata"]) : undefined,
    updateDimensionGroup: data["updateDimensionGroup"] !== undefined ? deserializeUpdateDimensionGroupRequest(data["updateDimensionGroup"]) : undefined,
    updateDimensionProperties: data["updateDimensionProperties"] !== undefined ? deserializeUpdateDimensionPropertiesRequest(data["updateDimensionProperties"]) : undefined,
    updateEmbeddedObjectBorder: data["updateEmbeddedObjectBorder"] !== undefined ? deserializeUpdateEmbeddedObjectBorderRequest(data["updateEmbeddedObjectBorder"]) : undefined,
    updateEmbeddedObjectPosition: data["updateEmbeddedObjectPosition"] !== undefined ? deserializeUpdateEmbeddedObjectPositionRequest(data["updateEmbeddedObjectPosition"]) : undefined,
    updateFilterView: data["updateFilterView"] !== undefined ? deserializeUpdateFilterViewRequest(data["updateFilterView"]) : undefined,
    updateNamedRange: data["updateNamedRange"] !== undefined ? deserializeUpdateNamedRangeRequest(data["updateNamedRange"]) : undefined,
    updateProtectedRange: data["updateProtectedRange"] !== undefined ? deserializeUpdateProtectedRangeRequest(data["updateProtectedRange"]) : undefined,
    updateSheetProperties: data["updateSheetProperties"] !== undefined ? deserializeUpdateSheetPropertiesRequest(data["updateSheetProperties"]) : undefined,
    updateSlicerSpec: data["updateSlicerSpec"] !== undefined ? deserializeUpdateSlicerSpecRequest(data["updateSlicerSpec"]) : undefined,
    updateSpreadsheetProperties: data["updateSpreadsheetProperties"] !== undefined ? deserializeUpdateSpreadsheetPropertiesRequest(data["updateSpreadsheetProperties"]) : undefined,
  };
}
...
function serializeResponse(data: any): Response {
  return {
    ...data,
    addDataSource: data["addDataSource"] !== undefined ? serializeAddDataSourceResponse(data["addDataSource"]) : undefined,
    refreshDataSource: data["refreshDataSource"] !== undefined ? serializeRefreshDataSourceResponse(data["refreshDataSource"]) : undefined,
    updateDataSource: data["updateDataSource"] !== undefined ? serializeUpdateDataSourceResponse(data["updateDataSource"]) : undefined,
  };
}
...
export interface SortSpec {
   ...
   * sorted to the top. Mutually exclusive with foreground_color. Deprecated:
   * Use background_color_style.
   */
  backgroundColor?: Color;
  /**
   * The background fill color to sort by; cells with this fill color are
   * sorted to the top. Mutually exclusive with foreground_color, and must be an
...
export interface Spreadsheet {
   ...
   */
  readonly dataSourceSchedules?: DataSourceRefreshSchedule[];
  /**
...
/**
 * Additional options for Sheets#spreadsheetsGet.
 */
export interface SpreadsheetsGetOptions {
  /**
   * True if grid data should be returned. This parameter is ignored if a field
   * mask was set in the request.
   */
...
/**
 * Additional options for Sheets#spreadsheetsValuesAppend.
 */
export interface SpreadsheetsValuesAppendOptions {
  /**
   * Determines if the update response should include the values of the cells
...
/**
 * Additional options for Sheets#spreadsheetsValuesBatchGet.
 */
export interface SpreadsheetsValuesBatchGetOptions {
  /**
   * How dates, times, and durations should be represented in the output. This
   * is ignored if value_render_option is FORMATTED_VALUE. The default dateTime
   * render option is SERIAL_NUMBER.
...
/**
 * Additional options for Sheets#spreadsheetsValuesGet.
 */
export interface SpreadsheetsValuesGetOptions {
  /**
   * How dates, times, and durations should be represented in the output. This
   * is ignored if value_render_option is FORMATTED_VALUE. The default dateTime
   * render option is SERIAL_NUMBER.
...
/**
 * Additional options for Sheets#spreadsheetsValuesUpdate.
 */
export interface SpreadsheetsValuesUpdateOptions {
  /**
   * Determines if the update response should include the values of the cells
   * that were updated. By default, responses do not include the updated values.
...
export interface TreemapChartSpec {
   ...
   * have the same color as cells with this value. If not specified, defaults to
   * the actual minimum value from color_data, or the minimum value from
   * size_data if color_data is not specified.
   */
  minValue?: number;
  /**
...
function serializeUpdateBandingRequest(data: any): UpdateBandingRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateBandingRequest(data: any): UpdateBandingRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateCellsRequest(data: any): UpdateCellsRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateCellsRequest(data: any): UpdateCellsRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateDataSourceResponse(data: any): UpdateDataSourceResponse {
  return {
    ...data,
    dataExecutionStatus: data["dataExecutionStatus"] !== undefined ? serializeDataExecutionStatus(data["dataExecutionStatus"]) : undefined,
  };
...
function deserializeUpdateDataSourceResponse(data: any): UpdateDataSourceResponse {
  return {
    ...data,
    dataExecutionStatus: data["dataExecutionStatus"] !== undefined ? deserializeDataExecutionStatus(data["dataExecutionStatus"]) : undefined,
  };
...
function serializeUpdateDeveloperMetadataRequest(data: any): UpdateDeveloperMetadataRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateDeveloperMetadataRequest(data: any): UpdateDeveloperMetadataRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateDimensionGroupRequest(data: any): UpdateDimensionGroupRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateDimensionGroupRequest(data: any): UpdateDimensionGroupRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateDimensionPropertiesRequest(data: any): UpdateDimensionPropertiesRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateDimensionPropertiesRequest(data: any): UpdateDimensionPropertiesRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateEmbeddedObjectBorderRequest(data: any): UpdateEmbeddedObjectBorderRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateEmbeddedObjectBorderRequest(data: any): UpdateEmbeddedObjectBorderRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateEmbeddedObjectPositionRequest(data: any): UpdateEmbeddedObjectPositionRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateEmbeddedObjectPositionRequest(data: any): UpdateEmbeddedObjectPositionRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateFilterViewRequest(data: any): UpdateFilterViewRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateFilterViewRequest(data: any): UpdateFilterViewRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateNamedRangeRequest(data: any): UpdateNamedRangeRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateNamedRangeRequest(data: any): UpdateNamedRangeRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateProtectedRangeRequest(data: any): UpdateProtectedRangeRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateProtectedRangeRequest(data: any): UpdateProtectedRangeRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateSheetPropertiesRequest(data: any): UpdateSheetPropertiesRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateSheetPropertiesRequest(data: any): UpdateSheetPropertiesRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateSlicerSpecRequest(data: any): UpdateSlicerSpecRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateSlicerSpecRequest(data: any): UpdateSlicerSpecRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function serializeUpdateSpreadsheetPropertiesRequest(data: any): UpdateSpreadsheetPropertiesRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
...
function deserializeUpdateSpreadsheetPropertiesRequest(data: any): UpdateSpreadsheetPropertiesRequest {
  return {
    ...data,
    fields: data["fields"] !== undefined ? data["fields"] : undefined,
  };
