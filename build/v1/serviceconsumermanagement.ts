...
/**
 * Service Consumer Management API Client for Deno
 * ===============================================
 * 
 * Manages the service consumers of a Service Infrastructure service.
 * 
 * Docs: https://cloud.google.com/service-consumer-management/docs/overview
...
export class ServiceConsumerManagement {
  ...
  constructor(client?: CredentialsClient, baseUrl: string = "https://serviceconsumermanagement.googleapis.com/") {
    this.#client = client;
   ...
   */
  async servicesSearch(parent: string, opts: ServicesSearchOptions = {}): Promise<SearchTenancyUnitsResponse> {
    const url = new URL(`${this.#baseUrl}v1/${ parent }:search`);
    if (opts.pageSize !== undefined) {
      url.searchParams.append("pageSize", String(opts.pageSize));
    }
    if (opts.pageToken !== undefined) {
    ...
    return data as SearchTenancyUnitsResponse;
  }
   ...
   */
  async servicesTenancyUnitsAddProject(parent: string, req: AddTenantProjectRequest): Promise<Operation> {
    const url = new URL(`${this.#baseUrl}v1/${ parent }:addProject`);
    const body = JSON.stringify(req);
    const data = await request(url.href, {
      client: this.#client,
      method: "POST",
   ...
   * configuration to keep the existing one. A service account in the project is
   * created if previously non existed. Specified labels will be appended to
   ...
   */
  async servicesTenancyUnitsApplyProjectConfig(name: string, req: ApplyTenantProjectConfigRequest): Promise<Operation> {
    const url = new URL(`${this.#baseUrl}v1/${ name }:applyProjectConfig`);
    const body = JSON.stringify(req);
    const data = await request(url.href, {
      client: this.#client,
      method: "POST",
   ...
   */
  async servicesTenancyUnitsAttachProject(name: string, req: AttachTenantProjectRequest): Promise<Operation> {
    const url = new URL(`${this.#baseUrl}v1/${ name }:attachProject`);
    const body = JSON.stringify(req);
    const data = await request(url.href, {
      client: this.#client,
      method: "POST",
   ...
   */
  async servicesTenancyUnitsCreate(parent: string, req: CreateTenancyUnitRequest): Promise<TenancyUnit> {
    const url = new URL(`${this.#baseUrl}v1/${ parent }/tenancyUnits`);
    const body = JSON.stringify(req);
    const data = await request(url.href, {
      client: this.#client,
      method: "POST",
   ...
   */
  async servicesTenancyUnitsDelete(name: string): Promise<Operation> {
    const url = new URL(`${this.#baseUrl}v1/${ name }`);
    const data = await request(url.href, {
      client: this.#client,
      method: "DELETE",
   ...
   * resource metadata, call the `RemoveTenantProject` method. New resources
   * with the same tag can't be added if there are existing resources in a
   * DELETED state. Operation.
   *
   * @param name Required. Name of the tenancy unit. Such as 'services/service.googleapis.com/projects/12345/tenancyUnits/abcd'.
   */
  async servicesTenancyUnitsDeleteProject(name: string, req: DeleteTenantProjectRequest): Promise<Operation> {
    const url = new URL(`${this.#baseUrl}v1/${ name }:deleteProject`);
    const body = JSON.stringify(req);
    const data = await request(url.href, {
      client: this.#client,
      method: "POST",
   ...
   */
  async servicesTenancyUnitsList(parent: string, opts: ServicesTenancyUnitsListOptions = {}): Promise<ListTenancyUnitsResponse> {
    const url = new URL(`${this.#baseUrl}v1/${ parent }/tenancyUnits`);
    if (opts.filter !== undefined) {
      url.searchParams.append("filter", String(opts.filter));
    }
    ...
    return data as ListTenancyUnitsResponse;
  }
   ...
   * @param name Required. Name of the tenancy unit. Such as 'services/service.googleapis.com/projects/12345/tenancyUnits/abcd'.
   */
  async servicesTenancyUnitsRemoveProject(name: string, req: RemoveTenantProjectRequest): Promise<Operation> {
    const url = new URL(`${this.#baseUrl}v1/${ name }:removeProject`);
    const body = JSON.stringify(req);
    const data = await request(url.href, {
      client: this.#client,
      method: "POST",
   ...
   * @param name Required. Name of the tenancy unit. Such as 'services/service.googleapis.com/projects/12345/tenancyUnits/abcd'.
   */
  async servicesTenancyUnitsUndeleteProject(name: string, req: UndeleteTenantProjectRequest): Promise<Operation> {
    const url = new URL(`${this.#baseUrl}v1/${ name }:undeleteProject`);
    const body = JSON.stringify(req);
    const data = await request(url.href, {
      client: this.#client,
      method: "POST",
...
export interface ServicesSearchOptions {
   ...
   * tag 'xyz', use the query `tenant_resources.tag=xyz`. To search tenancy
   * units that contain at least one tenant resource with a given resource name
 ...
 */
export interface ServicesTenancyUnitsListOptions {
  /**
...
function serializeV1Beta1BatchCreateProducerOverridesResponse(data: any): V1Beta1BatchCreateProducerOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (serializeV1Beta1QuotaOverride(item))) : undefined,
  };
}

function deserializeV1Beta1BatchCreateProducerOverridesResponse(data: any): V1Beta1BatchCreateProducerOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (deserializeV1Beta1QuotaOverride(item))) : undefined,
  };
}
...
function serializeV1Beta1ImportProducerOverridesResponse(data: any): V1Beta1ImportProducerOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (serializeV1Beta1QuotaOverride(item))) : undefined,
  };
...
function deserializeV1Beta1ImportProducerOverridesResponse(data: any): V1Beta1ImportProducerOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (deserializeV1Beta1QuotaOverride(item))) : undefined,
  };
...
function serializeV1Beta1ImportProducerQuotaPoliciesResponse(data: any): V1Beta1ImportProducerQuotaPoliciesResponse {
  return {
    ...data,
    policies: data["policies"] !== undefined ? data["policies"].map((item: any) => (serializeV1Beta1ProducerQuotaPolicy(item))) : undefined,
  };
}

function deserializeV1Beta1ImportProducerQuotaPoliciesResponse(data: any): V1Beta1ImportProducerQuotaPoliciesResponse {
  return {
    ...data,
    policies: data["policies"] !== undefined ? data["policies"].map((item: any) => (deserializeV1Beta1ProducerQuotaPolicy(item))) : undefined,
  };
}
...
function serializeV1Beta1ProducerQuotaPolicy(data: any): V1Beta1ProducerQuotaPolicy {
  return {
    ...data,
...
function deserializeV1Beta1ProducerQuotaPolicy(data: any): V1Beta1ProducerQuotaPolicy {
  return {
    ...data,
...
function serializeV1Beta1QuotaOverride(data: any): V1Beta1QuotaOverride {
  return {
    ...data,
...
function deserializeV1Beta1QuotaOverride(data: any): V1Beta1QuotaOverride {
  return {
    ...data,
...
export interface V1GenerateDefaultIdentityResponse {
   ...
   */
  attachStatus?:  | "ATTACH_STATUS_UNSPECIFIED" | "ATTACHED" | "ATTACH_SKIPPED" | "PREVIOUSLY_ATTACHED" | "ATTACH_DENIED_BY_ORG_POLICY";
  /**
