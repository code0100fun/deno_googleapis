...
/**
 * Firebase ML API Client for Deno
 * ===============================
 * 
...
export class FirebaseML {
  ...
  constructor(client?: CredentialsClient, baseUrl: string = "https://firebaseml.googleapis.com/") {
    this.#client = client;
...
/**
 * Additional options for FirebaseML#operationsList.
 */
