...
/**
 * Service Usage API Client for Deno
 * =================================
 * 
 * Enables services that service consumers want to use on Google Cloud Platform, lists the available or enabled services, or disables services that service consumers no longer use.
 * 
 * Docs: https://cloud.google.com/service-usage/
...
export class ServiceUsage {
  ...
  constructor(client?: CredentialsClient, baseUrl: string = "https://serviceusage.googleapis.com/") {
    this.#client = client;
  ...
  async servicesBatchEnable(parent: string, req: BatchEnableServicesRequest): Promise<Operation> {
    const url = new URL(`${this.#baseUrl}v1/${ parent }/services:batchEnable`);
    const body = JSON.stringify(req);
    const data = await request(url.href, {
      client: this.#client,
      method: "POST",
  ...
  async servicesBatchGet(parent: string, opts: ServicesBatchGetOptions = {}): Promise<BatchGetServicesResponse> {
    const url = new URL(`${this.#baseUrl}v1/${ parent }/services:batchGet`);
    ...
    return deserializeBatchGetServicesResponse(data);
  }
  ...
  async servicesGet(name: string): Promise<GoogleApiServiceusageV1Service> {
    ...
    return deserializeGoogleApiServiceusageV1Service(data);
  }
  ...
  async servicesList(parent: string, opts: ServicesListOptions = {}): Promise<ListServicesResponse> {
    ...
    return deserializeListServicesResponse(data);
  }
}
...
function serializeAdminQuotaPolicy(data: any): AdminQuotaPolicy {
  return {
    ...data,
    policyValue: data["policyValue"] !== undefined ? String(data["policyValue"]) : undefined,
  };
}

function deserializeAdminQuotaPolicy(data: any): AdminQuotaPolicy {
  return {
    ...data,
    policyValue: data["policyValue"] !== undefined ? BigInt(data["policyValue"]) : undefined,
  };
}
...
function serializeBatchCreateAdminOverridesResponse(data: any): BatchCreateAdminOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (serializeQuotaOverride(item))) : undefined,
  };
}

function deserializeBatchCreateAdminOverridesResponse(data: any): BatchCreateAdminOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (deserializeQuotaOverride(item))) : undefined,
  };
}
...
function serializeBatchCreateConsumerOverridesResponse(data: any): BatchCreateConsumerOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (serializeQuotaOverride(item))) : undefined,
  };
...
function deserializeBatchCreateConsumerOverridesResponse(data: any): BatchCreateConsumerOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (deserializeQuotaOverride(item))) : undefined,
  };
...
function serializeBatchEnableServicesResponse(data: any): BatchEnableServicesResponse {
  return {
    ...data,
    services: data["services"] !== undefined ? data["services"].map((item: any) => (serializeGoogleApiServiceusageV1Service(item))) : undefined,
  };
}

function deserializeBatchEnableServicesResponse(data: any): BatchEnableServicesResponse {
  return {
    ...data,
    services: data["services"] !== undefined ? data["services"].map((item: any) => (deserializeGoogleApiServiceusageV1Service(item))) : undefined,
  };
}
...
function serializeBatchGetServicesResponse(data: any): BatchGetServicesResponse {
  return {
    ...data,
    services: data["services"] !== undefined ? data["services"].map((item: any) => (serializeGoogleApiServiceusageV1Service(item))) : undefined,
  };
...
function deserializeBatchGetServicesResponse(data: any): BatchGetServicesResponse {
  return {
    ...data,
    services: data["services"] !== undefined ? data["services"].map((item: any) => (deserializeGoogleApiServiceusageV1Service(item))) : undefined,
  };
...
function serializeDisableServiceResponse(data: any): DisableServiceResponse {
  return {
    ...data,
    service: data["service"] !== undefined ? serializeGoogleApiServiceusageV1Service(data["service"]) : undefined,
  };
}

function deserializeDisableServiceResponse(data: any): DisableServiceResponse {
  return {
    ...data,
    service: data["service"] !== undefined ? deserializeGoogleApiServiceusageV1Service(data["service"]) : undefined,
  };
}
...
function serializeEnableServiceResponse(data: any): EnableServiceResponse {
  return {
    ...data,
    service: data["service"] !== undefined ? serializeGoogleApiServiceusageV1Service(data["service"]) : undefined,
  };
...
function deserializeEnableServiceResponse(data: any): EnableServiceResponse {
  return {
    ...data,
    service: data["service"] !== undefined ? deserializeGoogleApiServiceusageV1Service(data["service"]) : undefined,
  };
...
function serializeGoogleApiService(data: any): GoogleApiService {
  return {
    ...data,
...
function deserializeGoogleApiService(data: any): GoogleApiService {
  return {
    ...data,
...
function serializeGoogleApiServiceusageV1Service(data: any): GoogleApiServiceusageV1Service {
  return {
    ...data,
    config: data["config"] !== undefined ? serializeGoogleApiServiceusageV1ServiceConfig(data["config"]) : undefined,
  };
}

function deserializeGoogleApiServiceusageV1Service(data: any): GoogleApiServiceusageV1Service {
  return {
    ...data,
    config: data["config"] !== undefined ? deserializeGoogleApiServiceusageV1ServiceConfig(data["config"]) : undefined,
  };
}
...
function serializeGoogleApiServiceusageV1ServiceConfig(data: any): GoogleApiServiceusageV1ServiceConfig {
  return {
    ...data,
    quota: data["quota"] !== undefined ? serializeQuota(data["quota"]) : undefined,
  };
...
function deserializeGoogleApiServiceusageV1ServiceConfig(data: any): GoogleApiServiceusageV1ServiceConfig {
  return {
    ...data,
    quota: data["quota"] !== undefined ? deserializeQuota(data["quota"]) : undefined,
  };
...
function serializeImportAdminOverridesResponse(data: any): ImportAdminOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (serializeQuotaOverride(item))) : undefined,
  };
...
function deserializeImportAdminOverridesResponse(data: any): ImportAdminOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (deserializeQuotaOverride(item))) : undefined,
  };
...
function serializeImportAdminQuotaPoliciesResponse(data: any): ImportAdminQuotaPoliciesResponse {
  return {
    ...data,
    policies: data["policies"] !== undefined ? data["policies"].map((item: any) => (serializeAdminQuotaPolicy(item))) : undefined,
  };
}

function deserializeImportAdminQuotaPoliciesResponse(data: any): ImportAdminQuotaPoliciesResponse {
  return {
    ...data,
    policies: data["policies"] !== undefined ? data["policies"].map((item: any) => (deserializeAdminQuotaPolicy(item))) : undefined,
  };
}
...
function serializeImportConsumerOverridesResponse(data: any): ImportConsumerOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (serializeQuotaOverride(item))) : undefined,
  };
...
function deserializeImportConsumerOverridesResponse(data: any): ImportConsumerOverridesResponse {
  return {
    ...data,
    overrides: data["overrides"] !== undefined ? data["overrides"].map((item: any) => (deserializeQuotaOverride(item))) : undefined,
  };
...
function serializeListServicesResponse(data: any): ListServicesResponse {
  return {
    ...data,
    services: data["services"] !== undefined ? data["services"].map((item: any) => (serializeGoogleApiServiceusageV1Service(item))) : undefined,
  };
...
function deserializeListServicesResponse(data: any): ListServicesResponse {
  return {
    ...data,
    services: data["services"] !== undefined ? data["services"].map((item: any) => (deserializeGoogleApiServiceusageV1Service(item))) : undefined,
  };
...
/**
 * Additional options for ServiceUsage#operationsList.
 */
...
export interface QuotaOverride {
   ...
   * the key `region` and the value `us-east-1`; the override is only applied to
...
function serializeQuotaOverride(data: any): QuotaOverride {
  return {
    ...data,
    overrideValue: data["overrideValue"] !== undefined ? String(data["overrideValue"]) : undefined,
  };
}

function deserializeQuotaOverride(data: any): QuotaOverride {
  return {
    ...data,
    overrideValue: data["overrideValue"] !== undefined ? BigInt(data["overrideValue"]) : undefined,
  };
}
 ...
 */
export interface ServicesBatchGetOptions {
  /**
